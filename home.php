...
<section class="home">
   <div class="swiper home-slider">
      <div class="swiper-wrapper">
         <div class="swiper-slide slide" style="background:url(images/Header6.jpg) no-repeat">
            <div class="content">
         ...
         <div class="swiper-slide slide" style="background:url(images/Header4.jpg) no-repeat">
            <div class="content">
               <span>search, express, tour</span>
...
<section class="footer">
   ...
   <div class="credit"> © 2023 - <span> Team Undounded </span> - all rights reserved! </div>
</section>
<!-- footer section ends -->
<!-- swiper js link  -->
